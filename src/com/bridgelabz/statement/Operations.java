...
public class Operations {
	...
	public static void insertion() {
		...
		int result = SqlOperations.insert(emp);
	...
	public static void deletion() {
		...
		int result = SqlOperations.delete(emp);
	...
	public static void updation() {
		...
		case 1:
			...
			result = SqlOperations.edit(emp,"ename",scanner.next());
			break;
		case 2:
			System.out.println("Enter new email:");
			result = SqlOperations.edit(emp,"email",scanner.next());
			break;
		case 3:
			System.out.println("Enter new location:");
			result = SqlOperations.edit(emp,"elocation",scanner.next());
			break;
		case 4:
			System.out.println("Enter new phone no.:");
			result = SqlOperations.edit(emp,"ephoneno",scanner.next());
			break;
		default:
			break;
		}
